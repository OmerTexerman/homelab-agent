...
export default function Sidebar() {
  ...
  // Fork: scratch threads offer move/promote flows via shared dialogs.
  const {
  ...
  const handleThreadContextMenu = useCallback(
    (threadRef: ScopedThreadRef, position: { x: number; y: number }) => {
      void (async () => {
        ...
        // Fork: scratch threads offer move/promote (shared dialogs).
        ...
        // Fork: insert scratch-thread move/promote items just before the
        // "rename" separator, matching where the classic sidebar surfaces them.
        const renameIndex = baseMenuItems.findIndex((item) => item.id === "rename");
        const menuItems = isStandaloneThread
          ? [
              ...baseMenuItems.slice(0, renameIndex),
              ...STANDALONE_THREAD_CONTEXT_MENU_ITEMS,
              ...baseMenuItems.slice(renameIndex),
            ]
          : baseMenuItems;
