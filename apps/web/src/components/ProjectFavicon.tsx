...
export function ProjectFavicon(input: {
  ...
  // Homelab fork: projects are homelab environments, so the default fallback
  // is a server icon rather than upstream's folder.
  const FallbackIcon = input.fallbackIcon ?? ServerIcon;
