...
const SURFACE_DISABLED_REASONS = {
  ...
  memory: "Memory is only available when a project is open.",
...
const SURFACE_UNAVAILABLE_HINTS = {
  ...
  memory: "Available when a project is open.",
...
function RightPanelEmptyState(props: {
  ...
  const actions = [
    ...
    // Homelab fork: Files/Memory stay openable even before the thread exists
    // server-side — each panel renders a "waiting for the thread to start"
    // state and fills in on its own, which beats staring at greyed-out cards.
    // Terminal now follows upstream's project-scoped gating.
    {
      label: "Terminal",
    ...
    },
    {
      ...
      hidden: false,
      disabledReason: SURFACE_UNAVAILABLE_HINTS.memory,
