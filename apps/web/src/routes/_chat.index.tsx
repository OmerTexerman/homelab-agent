            ...
            <EmptyHeader className="max-w-none">
              ...
              <EmptyDescription className="mt-2 text-sm leading-relaxed text-muted-foreground/78">
                {cloudEnabled
                  ...
                  : "Open a pairing link from another Homelab Agent client or add a reachable server manually. Saved servers stay in this browser."}
              </EmptyDescription>
              <div className="mt-6 flex justify-center">
                <Button
                  render={
                ...
                >
                  <PlusIcon className="size-4" />
                  {cloudEnabled ? "Open Connections" : "Add server"}
                </Button>
              </div>
            </EmptyHeader>
          </div>
