...
/**
 * Fork-owned implementations of the thread-activity derivations behind the
 * threadTimelineReadModel seam: pending approvals and user-input requests,
 * active/proposed plan state, and the collapsed work log. Upstream-aligned
...
export function deriveWorkLogEntries(
  ...
  for (const activity of ordered) {
    ...
    if (isInterruptedRuntimeErrorActivity(activity)) continue;
