...
import {
  ...
  asString,
  itemDetail,
  mapItemLifecycle as mapCanonicalItemLifecycle,
  runtimeEventBase as buildRuntimeEventBase,
  toCanonicalItemType,
...
function runtimeEventBase(
  ...
  return buildRuntimeEventBase({
    event,
    canonicalThreadId,
    rawSource: eventRawSource(event),
  });
}
...
function mapItemLifecycle(
  ...
  return mapCanonicalItemLifecycle({
    event,
    canonicalThreadId,
    rawSource: eventRawSource(event),
    lifecycle,
